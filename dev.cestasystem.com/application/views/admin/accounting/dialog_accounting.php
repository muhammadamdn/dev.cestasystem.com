...
<form class="m-b-1" action="<?php echo site_url("admin/accounting/bankcash_update").'/'.$bankcash_id; ?>" method="post" name="bankcash_update" id="bankcash_update">
...
<form class="m-b-1" action="<?php echo site_url("admin/accounting/deposit_update").'/'.$deposit_id; ?>" method="post" name="deposit_update" id="deposit_update">
  <input type="hidden" name="_method" value="EDIT">
...
<form class="m-b-1" action="<?php echo site_url("admin/accounting/expense_update").'/'.$expense_id; ?>" method="post" name="expense_update" id="expense_update">
  <input type="hidden" name="_method" value="EDIT">
...
<form class="m-b-1" action="<?php echo site_url("admin/accounting/transfer_update").'/'.$transfer_id; ?>" method="post" name="transfer_update" id="transfer_update">
  <input type="hidden" name="_method" value="EDIT">
...
<form class="m-b-1" action="<?php echo site_url("admin/accounting/update_payer").'/'.$payer_id; ?>" method="post" name="update_payer" id="update_payer">
  <input type="hidden" name="_method" value="EDIT">
...
<form class="m-b-1" action="<?php echo site_url("admin/accounting/update_payee").'/'.$payee_id; ?>" method="post" name="update_payee" id="update_payee">
  <input type="hidden" name="_method" value="EDIT">
