...
<section id="basic-listgroup">
  <div class="row match-heights">
        ...
        <div class="card-body collapse in">
          <div class="card-blocks">
            <div class="list-group"> <a class="list-group-item list-group-item-action nav-tabs-link" href="#general" data-setting="1" data-profile-block="general" data-toggle="tab" aria-expanded="true" id="setting_1"> <i class="fa fa-user"></i> <?php echo $this->lang->line('xin_general');?> </a> <a class="list-group-item list-group-item-action nav-tabs-link" href="#system" data-setting="3" data-profile-block="system" data-toggle="tab" aria-expanded="true" id="setting_3"> <i class="ft-monitor"></i> <?php echo $this->lang->line('xin_system');?> </a> <a class="list-group-item list-group-item-action nav-tabs-link" href="#role" data-profile="4" data-profile-block="role" data-toggle="tab" aria-expanded="true" id="setting_4"> <i class="ft-lock"></i> <?php echo $this->lang->line('xin_employee_role');?> </a> <a class="list-group-item list-group-item-action nav-tabs-link" href="#payroll" data-profile="6" data-profile-block="payroll" data-toggle="tab" aria-expanded="true" id="setting_6"> <i class="fa fa-money"></i> <?php echo $this->lang->line('left_payroll');?> </a>
              ...
              <?php }?>
              <a class="list-group-item list-group-item-action nav-tabs-link" href="#email" data-profile="8" data-profile-block="email" data-toggle="tab" aria-expanded="true" id="setting_8"> <i class="ft-mail"></i> <?php echo $this->lang->line('xin_email_notifications');?> </a>
    ...
    <div class="col-lg-9 col-md-9 current-tab animated fadeInRight" id="general"  aria-expanded="false">
        ...
        <div class="card">
          <div class="card-header">
            <h4 class="card-title"><?php echo $this->lang->line('xin_general');?> <?php echo $this->lang->line('header_configuration');?></h4>
    ...
    <div class="col-md-9 current-tab animated fadeInRight" id="system" style="display:none;">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title"><?php echo $this->lang->line('xin_system');?> <?php echo $this->lang->line('header_configuration');?></h4>
          <a class="heading-elements-toggle"><i class="fa fa-ellipsis font-medium-3"></i></a>
          <div class="heading-elements">
            <ul class="list-inline mb-0">
              <li><a data-action="collapse"><i class="ft-minus"></i></a></li>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <label for="footer_text"><?php echo $this->lang->line('xin_setting_sys_ip_address');?>
                        <button type="button" class="btn btn-icon btn-pure primary itheme-btn" data-toggle="popover" data-placement="top" data-content="<?php echo $this->lang->line('xin_setting_sys_ip_address_details');?>" data-trigger="hover" data-original-title="<?php echo $this->lang->line('xin_setting_sys_ip_address');?>"><i class="ft-help-circle"></i></button>
                      </label>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="footer_text"><?php echo $this->lang->line('xin_setting_ip_restriction');?>
                        <button type="button" class="btn btn-icon btn-pure primary itheme-btn" data-toggle="popover" data-placement="top" data-content="<?php echo $this->lang->line('xin_setting_ip_restriction_details');?>" data-trigger="hover" data-original-title="<?php echo $this->lang->line('xin_setting_ip_restriction');?>"><i class="ft-help-circle"></i></button>
                      </label>
                      <br>
                      <input type="checkbox" class="js-switch switch" data-group-cls="btn-group-sm"  data-color="#3e70c9" data-secondary-color="#ddd" id="system_ip_restriction" <?php if($system_ip_restriction=='yes'):?> checked="checked" <?php endif;?> value="yes" />
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <div class="pull-xs-left m-r-1">
                        <input type="checkbox" class="js-switch switch" data-group-cls="btn-group-sm"  data-color="#3e70c9" data-secondary-color="#ddd" id="enable_current_year" <?php if($enable_current_year=='yes'):?> checked="checked" <?php endif;?> value="yes" />
                      </div>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <br>
                      <div class="pull-xs-left m-r-1">
                        <input type="checkbox" class="js-switch switch" data-group-cls="btn-group-sm"  data-color="#3e70c9" data-secondary-color="#ddd" id="enable_page_rendered" <?php if($enable_page_rendered=='yes'):?> checked="checked" <?php endif;?> value="yes" />
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-md-8">
                    <div class="form-group">
                      <label for="footer_text"><?php echo $this->lang->line('xin_setting_google_maps_api_key');?>
                        <button type="button" class="btn btn-icon btn-pure primary itheme-btn" data-toggle="popover" data-placement="top" data-content="<?php echo $this->lang->line('xin_setting_google_maps_api_key_details');?>" data-trigger="hover" data-original-title="<?php echo $this->lang->line('xin_setting_google_maps_api_key');?>"><i class="ft-help-circle"></i></button>
                      </label>
                      <br />
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="footer_text"><?php echo $this->lang->line('xin_enable_auth_bg_imgs');?>
                        <button type="button" class="btn btn-icon btn-pure primary itheme-btn" data-toggle="popover" data-placement="top" data-content="<?php echo $this->lang->line('xin_enable_auth_bg_imgs_details');?>" data-trigger="hover" data-original-title="<?php echo $this->lang->line('xin_enable_auth_bg_imgs');?>"><i class="ft-help-circle"></i></button>
                      </label>
                      <input type="checkbox" class="js-switch switch" data-group-cls="btn-group-sm"  data-color="#3e70c9" data-secondary-color="#ddd" id="enable_auth_background" <?php if($enable_auth_background=='yes'):?> checked="checked" <?php endif;?> value="yes" />
                    </div>
                  </div>
                </div>
                <div class="row">
    ...
    <div class="col-md-9 current-tab animated fadeInRight" id="role" style="display:none;">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title"><?php echo $this->lang->line('xin_employee_role');?> <?php echo $this->lang->line('header_configuration');?></h4>
          <a class="heading-elements-toggle"><i class="fa fa-ellipsis font-medium-3"></i></a>
          <div class="heading-elements">
            <ul class="list-inline mb-0">
              <li><a data-action="collapse"><i class="ft-minus"></i></a></li>
              ...
              <div class="box box-block bg-white">
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <br>
                    <div class="pull-xs-left m-r-1">
                      <input type="checkbox" class="js-switch switch" data-group-cls="btn-group-sm"  data-color="#3e70c9" data-secondary-color="#ddd" id="contact_role" <?php if($employee_manage_own_contact=='yes'):?> checked="checked" <?php endif;?> value="yes" />
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <br>
                    <div class="pull-xs-left m-r-1">
                      <input type="checkbox" class="js-switch switch" data-group-cls="btn-group-sm"  data-color="#3e70c9" data-secondary-color="#ddd" id="bank_account_role" <?php if($employee_manage_own_bank_account=='yes'):?> checked="checked" <?php endif;?> value="yes">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <br>
                    <div class="pull-xs-left m-r-1">
                      <input type="checkbox" class="js-switch switch" data-group-cls="btn-group-sm"  data-color="#3e70c9" data-secondary-color="#ddd" id="edu_role" <?php if($employee_manage_own_qualification=='yes'):?> checked="checked" <?php endif;?> value="yes">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <br>
                    <div class="pull-xs-left m-r-1">
                      <input type="checkbox" class="js-switch switch" data-group-cls="btn-group-sm"  data-color="#3e70c9" data-secondary-color="#ddd" id="work_role" <?php if($employee_manage_own_work_experience=='yes'):?> checked="checked" <?php endif;?> value="yes">
                    </div>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <br>
                    <div class="pull-xs-left m-r-1">
                      <input type="checkbox" class="js-switch switch" data-group-cls="btn-group-sm"  data-color="#3e70c9" data-secondary-color="#ddd" id="doc_role" <?php if($employee_manage_own_document=='yes'):?> checked="checked" <?php endif;?> value="yes">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <br>
                    <div class="pull-xs-left m-r-1">
                      <input type="checkbox" class="js-switch switch" data-group-cls="btn-group-sm"  data-color="#3e70c9" data-secondary-color="#ddd" id="pic_role" <?php if($employee_manage_own_picture=='yes'):?> checked="checked" <?php endif;?> value="yes">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <br>
                    <div class="pull-xs-left m-r-1">
                      <input type="checkbox" class="js-switch switch" data-group-cls="btn-group-sm"  data-color="#3e70c9" data-secondary-color="#ddd" id="profile_role" <?php if($employee_manage_own_profile=='yes'):?> checked="checked" <?php endif;?> value="yes">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <br>
                    <div class="pull-xs-left m-r-1">
                      <input type="checkbox" class="js-switch switch" data-group-cls="btn-group-sm"  data-color="#3e70c9" data-secondary-color="#ddd" id="social_role" <?php if($employee_manage_own_social=='yes'):?> checked="checked" <?php endif;?> value="yes">
                    </div>
                  </div>
                </div>
                <div class="row">
    ...
    <div class="col-md-9 current-tab animated fadeInRight" id="payroll" style="display:none;">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title"><?php echo $this->lang->line('left_payroll');?> <?php echo $this->lang->line('header_configuration');?></h4>
          <a class="heading-elements-toggle"><i class="fa fa-ellipsis font-medium-3"></i></a>
          <div class="heading-elements">
            <ul class="list-inline mb-0">
              <li><a data-action="collapse"><i class="ft-minus"></i></a></li>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <br>
                    <div class="pull-xs-left m-r-1">
                      <input type="checkbox" class="js-switch switch" data-group-cls="btn-group-sm"  data-color="#3e70c9" data-secondary-color="#ddd" id="payslip_password_generate" <?php if($is_payslip_password_generate==1):?> checked="checked" <?php endif;?> value="1" />
                    </div>
                  </div>
                </div>
              </div>
    ...
    <div class="col-md-9 current-tab animated fadeInRight" id="job" style="display:none;">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title"><?php echo $this->lang->line('dashboard_recruitment');?> <?php echo $this->lang->line('header_configuration');?></h4>
          <a class="heading-elements-toggle"><i class="fa fa-ellipsis font-medium-3"></i></a>
          <div class="heading-elements">
            <ul class="list-inline mb-0">
              <li><a data-action="collapse"><i class="ft-minus"></i></a></li>
            ...
            <?php echo form_open('admin/settings/job_info/'.$company_info_id, $attributes, $hidden);?>
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <br>
                  <div class="pull-xs-left m-r-1">
                    <input type="checkbox" class="js-switch switch" data-group-cls="btn-group-sm"  data-color="#3e70c9" data-secondary-color="#ddd" id="enable_job2" <?php if($enable_job_application_candidates=='yes'):?> checked="checked" <?php endif;?> value="yes">
                  </div>
                </div>
                <div class="form-group">
    ...
    <div class="col-md-9 current-tab animated fadeInRight" id="email" style="display:none;">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title"><?php echo $this->lang->line('xin_email_notification_config');?></h4>
          <a class="heading-elements-toggle"><i class="fa fa-ellipsis font-medium-3"></i></a>
          <div class="heading-elements">
            <ul class="list-inline mb-0">
              <li><a data-action="collapse"><i class="ft-minus"></i></a></li>
              ...
              <div class="box box-block bg-white">
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <br>
                    <div class="pull-xs-left m-r-1">
                      <input type="checkbox" class="js-switch switch" data-group-cls="btn-group-sm"  data-color="#3e70c9" data-secondary-color="#ddd" id="srole_email_notification" <?php if($enable_email_notification=='yes'):?> checked="checked" <?php endif;?> value="yes">
                    </div>
                  </div>
                </div>
                <div class="row">
    ...
    <div role="tabpanel" class="col-md-9 current-tab animated fadeInRight" id="file_manager" style="display:none;">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title"><?php echo $this->lang->line('xin_files_manager');?> <?php echo $this->lang->line('header_configuration');?></h4>
          <a class="heading-elements-toggle"><i class="fa fa-ellipsis font-medium-3"></i></a>
          <div class="heading-elements">
            <ul class="list-inline mb-0">
              <li><a data-action="collapse"><i class="ft-minus"></i></a></li>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <br>
                    <div class="pull-xs-left m-r-1">
                      <input type="checkbox" class="js-switch switch" data-group-cls="btn-group-sm"  data-color="#3e70c9" data-secondary-color="#ddd" id="view_all_files" <?php if($file_setting[0]->is_enable_all_files=='yes'):?> checked="checked" <?php endif;?> value="yes" />
                    </div>
                  </div>
                </div>
              </div>
