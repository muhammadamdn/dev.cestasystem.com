...
$mycompany = $this->Company_model->read_company_information($comp_id);
print_r($mycompany);
?>
<link rel="stylesheet" href="<?php echo base_url();?>skin/app-assets/vendors/orgchart/css/font-awesome.min.css">
<link rel="stylesheet" href="<?php echo base_url();?>skin/app-assets/vendors/orgchart/css/jquery.orgchart.css">
<link rel="stylesheet" href="<?php echo base_url();?>skin/app-assets/vendors/orgchart/css/style.css">
<style type="text/css">
.orgchart {
	background: #fff;
}
...
<script type="text/javascript" src="<?php echo base_url();?>skin/app-assets/vendors/orgchart/js/html2canvas.min.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>skin/app-assets/vendors/orgchart/js/jquery.orgchart.js"></script>
<?php $department = $this->Department_model->get_my_departments($comp_id);?>
<script type="text/javascript">
    $(function() {
    var datascource = {
      'name': '<?php echo $mycompany[0]->name;?>',
