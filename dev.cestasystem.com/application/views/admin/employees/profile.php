      ...
      <div class="col-xs-12">
        <div class="card profile-with-cover">
          ...
          <div class="media profil-cover-details">
            <div class="media-left pl-2 pt-2"> <a href="#" class="profile-image"> <img src="<?php echo $de_file;?>" class="rounded-circle img-border height-100" alt="Card image"> </a> </div>
              ...
              <div class="col-xs-6">
                ...
                <div class="col-xs-4 text-xs-right">
                  <div class="btn-group hidden-md-down" role="group" aria-label="Basic example"> <span class="btn btn-primary btn-file"> <?php echo $this->lang->line('xin_browse');?>
                    <input type="file" name="p_file" id="p_file"></span> </div>
                </div>
                <div class="col-xs-2">
      ...
      <div class="card-body collapse in">
        <div class="card-blocks">
          <div class="list-group">
            ...
            <?php } ?>
            <a class="list-group-item list-group-item-action nav-tabs-link" href="#shift" data-profile="12" data-profile-block="shift" data-toggle="tab" aria-expanded="true" id="user_profile_12"> <i class="fa fa-clock-o"></i> <?php echo $this->lang->line('xin_e_details_shift');?> </a>
