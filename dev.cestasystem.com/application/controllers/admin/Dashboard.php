...
class Dashboard extends MY_Controller {
	...
	public function employee_department()
	{
		...
		$c_name = array();
		$c_am = array();	
		$c_color = array('#00A5A8','#FF4558','#16D39A','#8A2BE2','#D2691E','#6495ED','#DC143C','#006400','#556B2F','#9932CC');
		$someArray = array();
		$j=0;
	...
	public function employee_designation()
	{
		...
		$c_name = array();
		$c_am = array();	
		$c_color = array('#9932CC','#556B2F','#16D39A','#DC143C','#D2691E','#8A2BE2','#FF976A','#FF4558','#00A5A8','#6495ED');
		$someArray = array();
		$j=0;
