...
class Theme extends MY_Controller
{
   ...
   /*Function to set JSON output*/
	...
	public function page_layouts() {
		...
		} else if($this->input->post('statistics_cards_background')==='') {
        	$Return['error'] = $this->lang->line('xin_error_thm_statistics_cards_background');
		} else if($this->input->post('employee_cards')==='') {
        	$Return['error'] = $this->lang->line('xin_error_thm_employee_cards');
		}
		...
		'boxed_layout' => $this->input->post('boxed_layout'),
		...
		'statistics_cards_background' => $this->input->post('statistics_cards_background'),
		'employee_cards' => $this->input->post('employee_cards'),
		'card_border_color' => $this->input->post('card_border_color')
		);
