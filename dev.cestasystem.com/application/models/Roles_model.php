...
class roles_model extends CI_Model {
  ...
  // Start Cesta
  // get my employes
  public function get_comp_roles($comp_id)
  {
    $comp_id = array('company_id' => $comp_id);
    return $this->db->get_where('xin_user_roles', $comp_id);
  }
  // End Cesta
  ...
  // Start Cesta
  // get my company roles
  public function my_company_roles($comp_id)
  {
    $query = $this->db->query("SELECT * from xin_user_roles WHERE company_id=$comp_id ");
      return $query->result();
  }
  // End Cesta
