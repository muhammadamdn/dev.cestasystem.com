...
class promotion_model extends CI_Model {
  ...
  // Start Cesta
  // get my employes
  public function get_my_promotions($comp_id) {
    $comp_id = array('company_id' => $comp_id);
    return $this->db->get_where('xin_employee_promotions', $comp_id);
  }
  // End Cesta

  // Start Cesta
  public function get_company_promotions($comp_id) {
    $comp_id = array('company_id' => $comp_id);
    $query = $this->db->get_where('xin_employee_promotions', $comp_id);
    return $query;
  }
  // End Cesta
