...
class employees_model extends CI_Model {
  ...
  // Start Cesta
  // get my employes
  public function get_my_employees($comp_id) {
    $comp_id = array('company_id' => $comp_id);
    return $this->db->get_where('xin_employees', $comp_id);
  }
  // End Cesta
	...
	public function get_total_employees() {
	 ...
	 public function read_employee_information($id) {
		...
		$condition = "user_id =" . $this->db->escape($id);
		$this->db->select('*');
 ...
 // Start Cesta
 public function fetch_all_my_employees($limit, $start, $comp_id) {
       $this->db->limit($limit, $start);
       $comp_id = array('company_id' => $comp_id);
       $query = $this->db->get_where('xin_employees', $comp_id);
