...
class project_model extends CI_Model {
	...
	public function completed_project_bugs($id) {
	  $query = $this->db->query("SELECT * from xin_projects_bugs where project_id ='".$id."' and status=1");
	...
	public function completed_project_tasks($id) {
	  $query = $this->db->query("SELECT * from xin_tasks where project_id ='".$id."' and task_status=2");
	  $cTasks = $query->num_rows();
